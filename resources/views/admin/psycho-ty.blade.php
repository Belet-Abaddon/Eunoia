            ...
            <main>
                                            ...
                                            @foreach ($phychoTys as $phychoTy)
                                                <tr class="hover:bg-gray-100">
                                                    ...
                                                    <td class="p-4 whitespace-nowrap flex items-center space-x-2">
                                                        ...
                                                        <form action="{{ route('admin.phychoTyDelete', $phychoTy->id) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('Are you sure you want to delete this psychological type?');">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                ...
                <div
                    ...
                    <div class="flex items-center mb-4 sm:mb-0">
                        <a href="{{ $phychoTys->previousPageUrl() }}"
                        ...
                        <span class="text-sm font-normal text-gray-500">Showing <span
                                class="text-gray-900 font-semibold">{{ $phychoTys->firstItem() }}-{{ $phychoTys->lastItem() }}</span>
                            of <span class="text-gray-900 font-semibold">{{ $phychoTys->total() }}</span></span>
                    </div>
