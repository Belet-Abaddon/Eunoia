                                        ...
                                        @foreach ($schedules as $schedule)
                                            <tr>
                                                ...
                                                <button type="button" data-modal-toggle="user-modal"
                                                    ...
                                                    <form action="{{ route('admin.scheduleDelete', $schedule->id) }}" method="POST"
                                                        onsubmit="return confirm('Are you sure you want to delete this therapist schedule?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                ...
                <div
                    ...
                    <div class="flex items-center mb-4 sm:mb-0">
                        ...
                        <span class="text-sm font-normal text-gray-500">Showing <span
                                class="text-gray-900 font-semibold">{{ $schedules->firstItem() }}-{{ $schedules->lastItem() }}</span>
                            of <span class="text-gray-900 font-semibold">{{ $schedules->total() }}</span></span>
                    </div>
