            ...
            <main>
                ...
                <div
                    ...
                    <div class="flex items-center mb-4 sm:mb-0">
                        <a href="{{ $therapists->previousPageUrl() }}"
                        ...
                        <span class="text-sm font-normal text-gray-500">Showing <span
                                class="text-gray-900 font-semibold">{{ $therapists->firstItem() }}-{{ $therapists->lastItem() }}</span>
                            of <span class="text-gray-900 font-semibold">{{ $therapists->total() }}</span></span>
                    </div>
