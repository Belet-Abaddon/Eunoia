                    ...
                    <div class="mb-1 w-full">
                        ...
                        <div class="sm:flex">
                            <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">   
                                <form class="lg:pr-3" action="{{ route('users.search') }}" method="GET" id="search-form">
                ...
                <div
                    ...
                    <div class="flex items-center mb-4 sm:mb-0">
                        ...
                        <span class="text-sm font-normal text-gray-500">Showing <span
                                class="text-gray-900 font-semibold">{{ $users->firstItem() }}-{{ $users->lastItem() }}</span>
                            of <span class="text-gray-900 font-semibold">{{ $users->total() }}</span></span>
                    </div>
